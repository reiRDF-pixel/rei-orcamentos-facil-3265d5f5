...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#1e2fd4" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "RF Orçamentos" },
      { title: "Rei dos Filtros — Sistema de Orçamentos" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Rei dos Filtros" },
